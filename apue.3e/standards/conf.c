...
main(int argc, char *argv[])
{
	...
	printf("_POSIX_V7_ILP32_OFF32 is defined (val is %ld)\n", (long)_POSIX_V7_ILP32_OFF32+0);
#else
	printf("_POSIX_V7_ILP32_OFF32 is undefined\n");
#endif
#ifdef _SC_V7_ILP32_OFF32
	pr_sysconf("sysconf says _POSIX_V7_ILP32_OFF32 =", _SC_V7_ILP32_OFF32);
#else
	printf("no symbol for _POSIX_V7_ILP32_OFF32\n");
#endif
	printf("\n");
#ifdef _POSIX_V7_ILP32_OFFBIG
	printf("_POSIX_V7_ILP32_OFFBIG is defined (val is %ld)\n", (long)_POSIX_V7_ILP32_OFFBIG+0);
#else
	printf("_POSIX_V7_ILP32_OFFBIG is undefined\n");
#endif
#ifdef _SC_V7_ILP32_OFFBIG
	pr_sysconf("sysconf says _POSIX_V7_ILP32_OFFBIG =", _SC_V7_ILP32_OFFBIG);
#else
	printf("no symbol for _POSIX_V7_ILP32_OFFBIG\n");
#endif
	printf("\n");
#ifdef _POSIX_V7_LP64_OFF64
	printf("_POSIX_V7_LP64_OFF64 is defined (val is %ld)\n", (long)_POSIX_V7_LP64_OFF64+0);
#else
	printf("_POSIX_V7_LP64_OFF64 is undefined\n");
#endif
#ifdef _SC_V7_LP64_OFF64
	pr_sysconf("sysconf says _POSIX_V7_LP64_OFF64 =", _SC_V7_LP64_OFF64);
#else
	printf("no symbol for _POSIX_V7_LP64_OFF64\n");
#endif
	printf("\n");
#ifdef _POSIX_V7_LPBIG_OFFBIG
	printf("_POSIX_V7_LPBIG_OFFBIG is defined (val is %ld)\n", (long)_POSIX_V7_LPBIG_OFFBIG+0);
#else
	printf("_POSIX_V7_LPBIG_OFFBIG is undefined\n");
#endif
#ifdef _SC_V7_LPBIG_OFFBIG
	pr_sysconf("sysconf says _POSIX_V7_LPBIG_OFFBIG =", _SC_V7_LPBIG_OFFBIG);
#else
	...
	printf("_XOPEN_STREAMS is defined (val is %ld)\n", (long)_XOPEN_STREAMS+0);
#else
